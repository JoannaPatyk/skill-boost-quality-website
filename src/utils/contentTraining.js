...
const contentTraining = {
    title: 'Szkolenia i podnoszenie kwalifikacji',
    description: [
        <p key={0}>
            Organizujemy specjalistyczne szkolenia dla pracowników oraz kadry zarządzającej w firmach spożywczych.
            Szkolenia te mają znaczenie w kontekście podnoszenia kwalifikacji, świadomości oraz kompetencji zespołu, co
            skutkuje wyższą jakością produkcji i ogólnego działania firmy. Szkolenia, które oferujemy stanowią cenny
