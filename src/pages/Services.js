        ...
        <Wrapper>
            ...
            <div className="services-container">
                <div className="services-title">
                    <h2>
                        Zapoznaj się z szeroką ofertą usług, które skutecznie przyspieszą rozwój Twojego
                        przedsiębiorstwa!
                    </h2>
                </div>
                ...
                <div className="services-description">
                    ...
                    <div className="service">
                        ...
                        <p>
                            ...
                            potwierdzające, że <span>działania są zgodne z wymaganiami</span> regulacyjnymi i
                            standardami.
                        </p>
                        <button className="btn service-btn">dowiedz się więcej</button>
                    </div>
                    <div className="service">
                        ...
                        <p>
                            Zewnętrzne spojrzenie na działanie firm w branży spożywczej, identyfikacja obszarów do
                            poprawy oraz optymalizacji co przyczynia się do{' '}
                    ...
                    <div className="service">
                        ...
                        <p>
                            Wsparcie w wdrażaniu, analizie, prowadzeniu oraz{' '}
                            <span>optymalizacji systemów zarządzania</span>
